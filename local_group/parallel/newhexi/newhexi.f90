...
INTEGER :: n,nm,ntb,haloon,dynfricton,hubbleon!,nnn
DOUBLE PRECISION :: tstop,massless,tstep,soft,toffset,hPI,goldenratio,hadjust,scalefrict
END MODULE
...
SUBROUTINE derivs(x,y,dydx)
 ...
 INTEGER :: u,uu
 DOUBLE PRECISION :: dist3,dist2,dist1,vrel,xpar,scalarp,beta,lncoulomb
